...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->water_light__DOT__count = VL_RAND_RESET_I(32);
    vlSelf->water_light__DOT__cur_sta = VL_RAND_RESET_I(4);
    vlSelf->water_light__DOT__nxt_sta = VL_RAND_RESET_I(4);
    vlSelf->water_light__DOT__led_count = VL_RAND_RESET_I(4);
